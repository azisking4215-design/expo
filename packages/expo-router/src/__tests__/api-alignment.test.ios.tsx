...
describe('API is aligned between toolbar, stack header items and link menu', () => {
  it('toolbar kitchen sink', () => {
    ...
    // TODO: implement missing props in native module
    ...
    // expect(NativeLinkPreviewAction.mock.calls[0][0].hidden).toBe(true);
      ...
      index: () => (
        <>
          ...
          <Stack.Header.Left>
            ...
            <Stack.Header.View style={{}} separateBackground hidesSharedBackground hidden>
      ...
      index: () => (
        <>
          ...
          <Link href="/">
            ...
            <Link.Menu hidden inline palette title="Test menu" destructive disabled icon="0.circle">
              <Link.MenuAction
                icon="mail"
                disabled
                destructive
